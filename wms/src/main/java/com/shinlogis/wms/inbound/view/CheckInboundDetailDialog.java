...
public class CheckInboundDetailDialog extends JDialog {
    ...
    public CheckInboundDetailDialog(Frame owner, IODetail detail, InboundDetailModel model) {
        ...
        btnSearch.addActionListener(e -> {
        	if (warehouseDAO.selectByCode(tfWarehouseCode.getText().trim().toString()).size() > 0) {
