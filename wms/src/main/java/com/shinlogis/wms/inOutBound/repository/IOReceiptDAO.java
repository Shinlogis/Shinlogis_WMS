...
public class IOReceiptDAO {
    ...
    public List<IOReceipt> selectInboundReceiptsWithItemInfo(Map<String, Object> filters) {
        ...
        sql.append("SELECT ")
                ...
                .append("  r.proccessed_date, ")
                .append("  r.location_id, ")
                .append("  l.location_name, ")
                .append("  l.address, ")
                // 첫 상품명
                .append("  ( ")
        ...
        sql.append("group by r.io_receipt_id");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Date p = rs.getDate("proccessed_date");
    ...
    public List<IOReceipt> selectInboundReceipts() {
        ...
        sql.append("r.created_at, r.scheduled_date, r.proccessed_date, ");
...
//		}
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ioReceipt.setProcessedDate(rs.getTimestamp("proccessed_date") != null ? rs.getDate("proccessed_date") : null);
    ...
    /**
     * 특정 입고 전표의 첫 상품명, 공급사명, 아이템 수를 조회하는 메서드
     *
     * @param ioReceiptId 조회할 io_receipt_id
     * @return
     * @author 김예진
     * @since 2025-06-22
     */
