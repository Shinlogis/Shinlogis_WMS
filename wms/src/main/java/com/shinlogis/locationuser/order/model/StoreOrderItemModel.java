...
public class StoreOrderItemModel extends AbstractTableModel {
	...
	public Object getValueAt(int row, int col) {
		...
		switch (col) {
        case 0: return storeOrderItem.getStoreOrderId();
        case 1: return storeOrderItem.getProduct().getProductName();
        case 2: return storeOrderItem.getQuantity();
        case 3: return storeOrderItem.getQuantity()*storeOrderItem.getProduct().getPrice();
        case 4: return storeOrderItem.getStatus();
        default: return null;
		}
	}
